...
var addToHome = (function (w) {
	var nav = w.navigator,
		...
		options = {
			...
			expire: 40320,					// Minutes to wait before showing the popup again (0 = always displayed)
	...
	function loaded () {
		...
		if ( !isReturningVisitor || lastVisit + 7*24*60*60*100 > now ) w.localStorage.setItem('addToHome', Date.now());
